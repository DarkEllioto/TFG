...
public class InventarioUI : Singleton<InventarioUI>
{
    ...
    private void InicializarInventario()
    {
        ...
        for (int i = 0; i < Inventario.Instance.NumeroDeSlots; i++)
        {
            ...
            //A�adimos al index de inventario slot la propiedas de cada uno
            nuevoSlot.Index = i;
            //A�adimos el nuevo slot disponible
    ...
    //A�adimos los metodos para habilitad y deshabilitar el evento
